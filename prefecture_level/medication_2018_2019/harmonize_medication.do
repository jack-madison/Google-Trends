...
import delimited "C:\Users\jack-\OneDrive\Documents\Hitoshi RA Files\google_trends_1819\prefecture_level\medication\medication_trends_data.csv", delimiter(comma) varnames(1)
...
gen medication_harmonized_daily = (weighted_daily / max_weighted_daily) * 100
...
/* Export the data */
export delimited "C:\Users\jack-\OneDrive\Documents\Hitoshi RA Files\google_trends_1819\prefecture_level\medication\medication_trends_data_harmonized.csv"
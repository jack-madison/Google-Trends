...
import delimited "C:\Users\jack-\OneDrive\Documents\GitHub\Google-Trends\prefecture_level\suicide_2016_2019\suicide_trends_data.csv", delimiter(comma) varnames(1)
...
gen suicide_harmonized_daily = (weighted_daily / max_weighted_daily) * 100
...
/* Export the data */
export delimited "C:\Users\jack-\OneDrive\Documents\GitHub\Google-Trends\prefecture_level\suicide_2016_2019\suicide_trends_data_harmonized.csv"
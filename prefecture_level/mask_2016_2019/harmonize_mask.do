...
import delimited "C:\Users\jack-\OneDrive\Documents\GitHub\Google-Trends\prefecture_level\mask_2016_2019\mask_trends_data.csv", delimiter(comma) varnames(1)
...
gen mask_harmonized_daily = (weighted_daily / max_weighted_daily) * 100
...
/* Export the data */
export delimited "C:\Users\jack-\OneDrive\Documents\GitHub\Google-Trends\prefecture_level\mask_2016_2019\mask_trends_data_harmonized.csv"